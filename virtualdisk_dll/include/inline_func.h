...
/************************************************************************/
/*	@Func StrStr_Wild()
/*				   查询在源字符串中是否有目标子串---> 不区分大小写 且 匹配 "?"
/*	@Para src	   查询字符串
/*	@Para target   子串
/************************************************************************/

extern char *StrStr_Wild(const char *src, const char *target);

extern char* TranslateInput(char* str);


/************************************************************************/
/*  @Func CheckFileName()
/*					判断文件名是否有效
/*	@Para FileName	 待处理的文件名
/*	@Ret  true 合法 false 不合法
/************************************************************************/
extern bool CheckFileName(const char* FileName);

/************************************************************************/
/*  @Func CheckPathName()
/*					判断路径名是否有效
/*	@Para PathName	 待处理的路径名
/*	@Ret  true 合法 false 不合法
/************************************************************************/
extern bool CheckPathName(const char* PathName);

/************************************************************************/
/*  @Func strCompare()
/*					字符串匹配，包含通配符
/************************************************************************/
extern bool strCompare(const char *str1, const char *str2);
